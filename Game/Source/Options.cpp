...
void Options::CreatePauseButtons() {
    ...
    void Options::continuar(GuiControl * ctrl)
    {
        //app->pause->Disable();
    ...
    void Options::opciones(GuiControl * ctrl)
    {
        inpause = false;
        inajustes = true;
        CleanUp();
    ...
    void Options::salir(GuiControl * ctrl)
    {
    ...
    void Options::volver(GuiControl* ctrl) {
        CleanUp();
        inpause = true;
        inajustes = false;
        CreatePauseButtons();
    }
    void Options::fullscreen1(GuiControl* ctrl) {
        if (fullscreen == true) {
    ...
    void Options::vyscn(GuiControl* ctrl) {
        if (vsycn == true) {
            vsycn = false;
        }
        else if (vsycn == false) {
    ...
    void Options::volumen1(GuiControl* ctrl) {
        app->audio->MusicDown();
    }
    void Options::volumen2(GuiControl* ctrl) {
        app->audio->MusicUp();
    }
    void Options::fx1(GuiControl* ctrl) {
        app->audio->FxDown();
    }
    void Options::fx2(GuiControl* ctrl) {
        app->audio->FxUp();
    }